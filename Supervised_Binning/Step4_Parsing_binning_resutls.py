...
def Main():
    ...
    parser.add_argument("-c", "--centrifuge", required=False, default="Step1_parsed_centrifuge_results_eukLong.txt")
    parser.add_argument("-d", "--depth", required=False, default="Eukfinder_long_EUnk.depth.txt")
    parser.add_argument("-b", "--binning", required=False, default="Step3.5_binning_results.tsv")
    parser.add_argument("-p", "--plast", required=False, default="Step2_parsed_Plast_Acc2tax_results.txt")
