...
2. Parses Centrifuge results to output a file "Step1_parsed_centrifuge_results_eukLong.txt".
...
def translate_taxid_superkingdom():
    ...
    parser.add_argument('-o', '--output', required=False, help="Path to output file", default="Step1_parsed_centrifuge_results_eukLong.txt")
    ...
    if args.output:
        ...
        output_file = "parsed_centrifuge_results_eukLong2.txt"
